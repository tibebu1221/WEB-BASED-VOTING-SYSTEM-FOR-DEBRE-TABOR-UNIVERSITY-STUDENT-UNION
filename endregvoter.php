...
<td colspan="2" bgcolor="#2f4f4f" id="Menus" style="height:auto;border-radius:12px;">
		<ul>
			...
			<li class="active"><a href="endregvoter.php">end date reg_voter</a></li>
			<li><a href="regcan_date.php">register candidate_date</a></li>
...
<td><div style="clear: both"></div>
	...
	<font size="2"><h2> &nbsp;&nbsp; <u>Specify end date registration Here:</u></h2> </font><br/>
	...
	{
	$date = $_POST['date'];
	mysql_query("DELETE FROM  endreg_voter WHERE year(date)=year('$date') ");
	$qry = mysql_query("INSERT INTO  endreg_voter values('$date', '$user_id')");
	if($qry)
	{
	...
	echo '<meta content="2;endregvoter.php" http-equiv="refresh"/>';
