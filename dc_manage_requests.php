...
// Check columns in request table
$request_columns = [];
...
$sql = "SELECT r.requestID, r.candidateID, r.officeID, r.submitted_at, r.discipline_status";
...
// Add reviewed_at column if it exists
...
if ($filter_discipline && $filter_discipline !== 'all') {
    if ($filter_discipline === '') {
        // When filter_discipline is empty string, we want records where discipline_status is NULL or empty
        $where_conditions[] = "(r.discipline_status IS NULL OR r.discipline_status = '')";
    } else {
        $where_conditions[] = "r.discipline_status = ?";
        $sql_params[] = $filter_discipline;
    }
}
...
if ($stmt = $conn->prepare($sql)) {
    ...
    if (!empty($sql_params)) {
        $types = str_repeat('s', count($sql_params)); // All params are strings
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        if (isset($row['discipline_status'])) {
            if ($row['discipline_status'] === 'clear') {
                $cleared_count++;
    ...
    $_SESSION['msg'] = ['type'=>'error','text'=>'Database query error occurred!'];
}
?>
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-header">
                <a href="e_officer.php" class="logo">
                    ...
                    <div class="logo-text">
                        <h2>Disicipline Committee Panel</h2>
            ...
            <nav class="nav-menu">
                ...
                <a href="dc_manage_requests.php" class="nav-item active">
        ...
        <main class="main-content">
            ...
            <div class="header">
                ...
                <p>View and manage all candidate nomination requests</p>
            </div>
            ...
            <div class="content-area">
                <div class="content-header">
                    <h2>
                        ...
                        All Candidate Requests
                    </h2>
                    <div style="color: var(--gray); font-size: 0.9rem;">
                        Showing <?php echo $all_requests_count; ?> requests
                    </div>
                </div>
                ...
                <form method="get" class="filters">
                    <div class="filter-group">
                        <label for="discipline">Discipline Status:</label>
                        <select name="discipline" id="discipline" class="filter-select">
                            <option value="all" <?php echo ($filter_discipline === 'all' || $filter_discipline === '') ? 'selected' : ''; ?>>All</option>
                            <option value="" <?php echo $filter_discipline === '' ? 'selected' : ''; ?>>Not Reviewed</option>
                            <option value="clear" <?php echo $filter_discipline === 'clear' ? 'selected' : ''; ?>>Cleared</option>
                            <option value="disciplinary_action" <?php echo $filter_discipline === 'disciplinary_action' ? 'selected' : ''; ?>>Issues Found</option>
                        </select>
                    </div>
                    ...
                    <a href="dc_manage_requests.php" class="reset-btn">
                ...
                <div class="empty-state">
                    ...
                    <p>No candidate requests match your current filters.</p>
                    <a href="dc_manage_requests.php" class="btn btn-primary">
                ...
                <div class="requests-container">
                    <table class="requests-table">
                        ...
                        <tbody>
                            ...
                            // Get reviewed date if available
                            $reviewed_date = isset($request['reviewed_at']) && $request['reviewed_at'] ? date("M d, Y", strtotime($request['reviewed_at'])) : 'Not reviewed';
                            ?>
                            <tr>
                                <td>
    ...
    <script>
        ...
        // Function to open review modal when clicking on a table row
        function openReviewModalForRow(requestID, candidateName, candidateID, candidateCGPA, candidateYear, office, currentStatus, currentNotes) {
            // Set request ID
            ...
            // Set current notes
            document.getElementById('review_notes').value = currentNotes !== 'No review notes' ? currentNotes : '';
        ...
        // Make table rows clickable to open review modal
        document.addEventListener('DOMContentLoaded', function() {
            ...
            tableRows.forEach(row => {
                row.addEventListener('click', function(e) {
                    ...
                    const requestID = this.querySelector('.request-id')?.textContent.replace('#', '');
                    const candidateName = this.querySelector('td:nth-child(2) strong')?.textContent;
                    
                    // You'll need to store additional data in data attributes on the row
                    if (requestID && candidateName) {
                        // In a real implementation, you would fetch this data via AJAX
                        // For now, we'll use a simplified version
                        alert('Click functionality to be implemented. In a full implementation, this would open the review modal.');
                    }
                });
